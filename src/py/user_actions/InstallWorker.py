...
from constants import (
	...
	GARAGE_BINARY, GARAGE_INSTALL_URL, GIT_BINARY, GROUPADD_BINARY,
	MAIN_EMAIL, MAIN_HOST, NEW_NPM_BINARY, OLD_NPM_BINARY, PIP_BINARY,
	PROJECT_SOURCE, GROBID_DIR_PATH, GROBID_EXEC_PATH, GROBID_SOURCE,
	PACMAN_BINARY, PROJECT_ETC_DIR, PROJECT_GIT_DIR, SERVICE_BINARY,
...
class InstallWorker(UserAction):
	...
	def execute(self):
		...
		if exists(APT_GET_BINARY):
			...
			threads.append(
				Popen([PACMAN_BINARY, "-S", *PACMAN_DEPENDENCIES])
			)
		pip3_packages = [
